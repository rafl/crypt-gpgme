...

{
    ...
    is ($keylist_mode, 'local', 'default keylist_mode is local');
}
...
for my $mode (qw/extern sigs sig-notations validate local/) {
...

    {
        ...
        is ($keylist_mode, $mode, 'setting keylist_mode worked');
    }
}
...

{
    ...
    is ($keylist_mode, 'local', 'calling set_keylist_mode without arguments sets to local');
}
